...
module.exports = {
	...
	module: {
		loaders: [
			...
			{test: /\.html$/,loader: "ngtemplate-loader!html-loader?module=myTemplates&relativeTo="+(path.resolve(__dirname, './'))},
			{test: /\.(png|woff|woff2|eot|ttf|svg)$/, loader: 'file-loader?name=[path][name].[ext]&publicPath=&outputPath=./&context=app' }
		]
	},
	...
	plugins : [
	new ExtractTextPlugin({filename: "styles___[hash].css",allChunks: true}),
	...
	entry: {
		//dependencies after app.js can be removed if we change 
		//their module from metaApplicationApp
		app: [ './app/app.ts' ],
